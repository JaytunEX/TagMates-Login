...
const styles = StyleSheet.create({
  ...
  container: {
    flexDirection: 'column', // Cambia a 'row' para alinearlos horizontalmente
    justifyContent: 'flex-start', // Opciones: 'flex-start', 'flex-end', 'center', 'space-between', 'space-around'
    alignItems: 'center', // Opciones: 'flex-start', 'flex-end', 'center', 'stretch', 'baseline'
    backgroundColor: '#FAF6F6'
  },
